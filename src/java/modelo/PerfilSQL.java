...
//****************************************************************************************
     ...
     public JSONArray cargarPerfilGerente()
    {
        JSONArray perfiles = new JSONArray();
        JSONObject perfil = new JSONObject();
        ...
        try
        {
            ...
            this.st = this.cn.createStatement();
            String sql;
            sql = "SELECT * FROM usuarios WHERE tipo_usuario = 'G'";
            this.rs = this.st.executeQuery(sql);
...
//***********************************************************************************************
   ...
   public JSONObject datosPerfilGerente(String idUsuario)
    {
        JSONObject Perfil = new JSONObject();
        try
        {
     ...
     public boolean ModificarPerfilGerente(JSONObject datos, String tipoUsuario, String id_usuario)
    {
        try
        {
            this.cn = getConnection();
     ...
     public boolean ModificarPerfilVendedor(JSONObject datos, String tipoUsuario, String id_usuario)
    {
        try
        {
            this.cn = getConnection();
