...
--
-- Servidor: localhost
-- Tiempo de generación: 19-11-2012 a las 20:45:33
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `nombre_contacto` varchar(10) DEFAULT NULL,
  `celular` varchar(20) DEFAULT NULL,
  `foto` varchar(1) DEFAULT NULL,
...
INSERT INTO `clientes` (`id_cliente`, `cedula`, `razon_social`, `nombre`, `direccion`, `telefono`, `nombre_contacto`, `celular`, `foto`, `email`, `maximo_credito`, `estado`, `comentario`, `documentos_de_Soporte`, `responsable`) VALUES
('01', '9502040616', 'surtipiolo', 'Andres', 'la churria', '2525662', 'andres_fel', '3152695948', 'f', 'andres.chirri@hotmail.com', '1500000', 'viudo', 'villa_ligia', '19.499.611', 'la_mama'),
('02', '9508060719', 'pimpollo', 'Santiago', 'Boston', '3265984', 'santiago_v', '3156984658', 'f', 'santivalencia@hotmail.com', '2000000', 'casado', 'peludo_barbado', 'cedula', 'los_papas'),
('03', '18.688.359', 'maxxitope', 'edwar', 'playa_rica', '2695368', 'edwar_mass', '3006955560', 'f', 'maxxitope@hotmail.com', '0000000', 'soltero', 'pata_de_palo', 'hipotecas', 'forever_alone'),
('04', '17.466.358', 'galaxia_tecnologica', 'mauricio', 'los_pinos', '2589467', 'mauro', '3185562249', 'f', 'galaxia@hotmail.com', '9.999.999', 'casado', 'Galaxia_Tecnologica', 'empresa', 'la_esposa');
...
CREATE TABLE IF NOT EXISTS `colores` (
  `identificador` varchar(12) NOT NULL DEFAULT '',
  `tonalidad` varchar(10) DEFAULT NULL,
  `codigo_producto` varchar(12) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `devolucion` (
  ...
  `id_devolucion` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(161, 'Cartagena', 'Atlantico', '08'),
(162, 'Achí', 'Atlantico', '08'),
(163, 'Altos del Rosario', 'Atlantico', '08'),
(164, 'Arenal', 'Atlantico', '08'),
(165, 'Arjona', 'Atlantico', '08'),
(166, 'Arroyohondo', 'Atlantico', '08'),
(167, 'Barranco de Loba', 'Atlantico', '08'),
(168, 'Calamar', 'Atlantico', '08'),
(169, 'Cantagallo', 'Atlantico', '08'),
(170, 'Cicuto', 'Atlantico', '08'),
(171, 'Córdoba', 'Atlantico', '08'),
(172, 'Clemencia', 'Atlantico', '08'),
(173, 'El Carmen de Bolívar', 'Atlantico', '08'),
(174, 'El Guamo', 'Atlantico', '08'),
(175, 'El Peñón', 'Atlantico', '08'),
(176, 'Hatillo de Loba', 'Atlantico', '08'),
(177, 'Magangue', 'Atlantico', '08'),
(178, 'Mahates', 'Atlantico', '08'),
(179, 'Margarita', 'Atlantico', '08'),
(180, 'María la Baja', 'Atlantico', '08'),
(181, 'Montecristo', 'Atlantico', '08'),
(182, 'Mompós', 'Atlantico', '08'),
(183, 'Morales', 'Atlantico', '08'),
(184, 'Pinillos', 'Atlantico', '08'),
(185, 'Regidor', 'Atlantico', '08'),
(186, 'Río Viejo', 'Atlantico', '08'),
(187, 'San Cristóbal', 'Atlantico', '08'),
(188, 'San Estanislao', 'Atlantico', '08'),
(189, 'San Fernando', 'Atlantico', '08'),
(190, 'San Jacinto', 'Atlantico', '08'),
(191, 'San Jacinto del Cauca', 'Atlantico', '08'),
(192, 'San Juan Nepomuceno', 'Atlantico', '08'),
(193, 'San Martín de Loba', 'Atlantico', '08'),
(194, 'San Pablo', 'Atlantico', '08'),
(195, 'Santa Catalina', 'Atlantico', '08'),
(196, 'Santa Rosa', 'Atlantico', '08'),
(197, 'Santa Rosa del Sur', 'Atlantico', '08'),
(198, 'Simití', 'Atlantico', '08'),
(199, 'Soplaviento', 'Atlantico', '08'),
(200, 'Talaigua Nuevo', 'Atlantico', '08'),
(201, 'Tiquisio (Puerto Rico)', 'Atlantico', '08'),
(202, 'Turbaco', 'Atlantico', '08'),
(203, 'Turbaná', 'Atlantico', '08'),
(204, 'Villanueva', 'Atlantico', '08'),
(205, 'Zambrano', 'Atlantico', '08'),
(206, 'Tunja', 'Boyacá', '15'),
...
CREATE TABLE IF NOT EXISTS `orden_produccion` (
  ...
  `id_pedido` varchar(12) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pagos` (
  `numero_de_factura` varchar(20) DEFAULT NULL,
  `id_cliente` varchar(12) DEFAULT NULL,
  `nombre_cliente` varchar(10) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `id_vendedor` varchar(12) DEFAULT NULL,
  `nombre_del_vendedor` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  `id_pedido` varchar(10) NOT NULL DEFAULT '',
  `numero_del_producto` varchar(20) DEFAULT NULL,
  `valor_del_iva` decimal(10,2) DEFAULT NULL,
  `valor_total` decimal(10,2) DEFAULT NULL,
  `nombre_del_cliente` char(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `productos` (
  `codigo_producto` varchar(12) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ubicacion_geografica` (
  `id_usuario` varchar(12) NOT NULL DEFAULT '',
  `lantitud` decimal(6,0) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `nickname_usuario` varchar(20) DEFAULT NULL,
  `password_usuario` varchar(40) DEFAULT NULL,
  `tipo_usuario` varchar(20) DEFAULT NULL,
  `foto_usuario` varchar(50) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `fecha_cumpleanos` date DEFAULT NULL,
  `banco` int(11) DEFAULT NULL,
  `tipo_cuenta_bancaria` int(11) DEFAULT NULL,
...
(2, 'Nicolas', 'Diaz Franco', '95020406160', 'macarena c19 m1', '2525662', '3175581102', 'nicolas_950404@hotmail.com', 'Nicolas', 'gerente', 'G', 'foto_usuario', '2012-10-01', '1995-02-04', 4, 6, '629-926-269-296', 'Ahorro'),
(3, 'Jasinto', 'Masso Menos', '6543435456', 'Milan casa 17', '54656456', '5454561156', 'gerente@surtiplas.com', 'Jasinto', 'gerente', 'G', 's', '2012-10-01', '1988-10-18', 1, 0, '111-222-333-4444', 'Ahorro'),
(4, 'Pedro Andres', 'Perez Ossa', '868686868', 'call3', '23232', '3400000', 'pepe@gmail.com', 'pepe', 'pepe', 'V', 'foto_usuario', '2010-02-03', '1988-10-06', 1, 1, '22-222-222-6667', 'null'),
...
CREATE TABLE IF NOT EXISTS `viaticos` (
  `id_viaticos` varchar(10) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `visitas` (
  ...
  `direccion_del_cliente` varchar(15) DEFAULT NULL,
  `descripcion` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
